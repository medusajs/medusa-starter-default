...
export class Migration20250705143725 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_technician_employee_id_unique" ON "technician" (employee_id) WHERE deleted_at IS NULL;`);
