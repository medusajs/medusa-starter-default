...
const orderSchema = zod.object({
  ...
  fulfillment_type: zod.enum(["pickup", "shipping"]).default("pickup"),
    ...
    mutationFn: async (data: OrderFormData) => {
      ...
      const orderData = {
        ...
        items: data.items.map(item => ({
          ...
          requires_shipping: data.fulfillment_type === "shipping",
        })),
                ...
                <div className="flex w-full max-w-[736px] flex-col justify-center px-2 pb-2">
                  <div className="flex flex-col divide-y divide-dashed">
                    ...
                    <div className="py-8">
                      <div className="flex flex-col gap-2 xl:flex-row xl:items-center">
                        <div className="flex-1">
                          <Label htmlFor="fulfillment-type">Fulfillment Method</Label>
                          <Text size="small" className="text-ui-fg-subtle">
                        ...
                        <div className="flex-1">
                          ...
                          />
                          {form.formState.errors.fulfillment_type && (
                            <Text size="small" className="text-ui-fg-error">
                              {form.formState.errors.fulfillment_type.message}
                            </Text>
                          )}
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col gap-y-1">
                          {selectedItems.length > 0 ? (
                            selectedItems.map((item) => (
                              <div key={item.variant_id} className="flex items-center justify-between rounded border border-ui-border-base bg-ui-bg-subtle p-3">
                                <div className="flex-1">
                            ...
                            <div 
                              className="bg-ui-bg-field mt-4 block h-[120px] w-full rounded-lg border border-dashed flex items-center justify-center"
                              style={{
